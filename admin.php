...
<body class="bg-background-color custom-scrollbar">
    <div class="container mx-auto p-6 animate-fadeIn">
        ...
        <button id="toggle-dark-mode">تبديل الوضع المظلم</button>

<script>
  const toggleButton = document.getElementById('toggle-dark-mode');

  // التحقق من الوضع المظلم الحالي في التخزين المحلي
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="info_key.php?key_id=<?php echo $key['id']; ?>" class="btn btn-info btn-sm">معلومات</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
